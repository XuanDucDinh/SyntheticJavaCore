    ...
    * */
    public static String[] reorderLogFiles(String[] logs) {
        ...
        Arrays.sort(logs, (log1, log2) -> {
            ...
            boolean isNum1 = Character.isDigit(arr1[1].charAt(0));
            boolean isNum2 = Character.isDigit(arr2[1].charAt(0));
            // arrange letter log and digit logs
            ...
            else return arr1[1].compareTo(arr2[1]);
    ...
    public static void main(String[] args) {
        // given arrays of logs, Each log's element : first word is the identifier.
